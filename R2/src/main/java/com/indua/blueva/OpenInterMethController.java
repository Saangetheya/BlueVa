...
public class OpenInterMethController implements Initializable {
    @FXML
    ...
    void removeMethod(MouseEvent event) {
        ...
        bjInterface.removeMethod(Misc.notagain0.get(classMethObj.getNameColumn()));
        Misc.notagain0.remove(classMethObj.getNameColumn());
